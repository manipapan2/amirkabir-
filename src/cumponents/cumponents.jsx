...
export function Card(props) {
  ...
  return (
    <div className="tozih marginTozih" id="tozih" onMouseEnter={tozihEnterAndLeave} onMouseLeave={tozihEnterAndLeave} ref={tozih1Ref} style={{marginBottom: `${props.marginBottom}`}}>
      <div className="neveshte1Div pi4" id="neveshte1Div" style={{ backgroundImage: `url(${props.aks})` }} ref={neveshte1DivRef}><p className="p1" id="p1" ref={p1Ref}>{props.neveshte1}</p></div>
